...
const scanners: Scanner[] = [scanEnvFiles, scanGitHubActions, scanGitLabCI, scanCircleCI, scanJenkins, scanRailway, scanRender, scanDocker, scanVercel, scanNextJs, scanSupabase, scanCapRover];
