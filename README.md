...
- [`docs/articles/heroku-env-variable-troubleshooting.md`](docs/articles/heroku-env-variable-troubleshooting.md) — troubleshooting checklist for Heroku dyno, review-app, and release-phase env drift without requiring Heroku API access.
- [`docs/articles/digitalocean-app-platform-env-variable-troubleshooting.md`](docs/articles/digitalocean-app-platform-env-variable-troubleshooting.md) — troubleshooting checklist for DigitalOcean App Platform deploy, worker, and job env drift without requiring DigitalOcean API access.
...
jobs:
  secret-coverage:
    ...
    steps:
      ...
      - uses: leviro-ai/secret-coverage@v0.2.4
        with:
          strict: 'false'
          format: markdown
```
