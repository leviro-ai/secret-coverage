...
- [ ] Recurring heartbeat guard: check local package version vs published npm version; when it changes, inspect release/code/doc changes and update local `CONTEXT.md`, active plans, TODO/progress notes, and stale publish packets before the next marketing/build slice
...
- [x] Individual future integration pages for Fly.io, Firebase, CapRover
  - [x] Fly.io environment variable troubleshooting page
  - [x] Firebase environment variable troubleshooting page
  - [x] CapRover environment variable troubleshooting page
